...
const Class2 = () => {
  const schedule = [
    ...
    { day: "Úterý", subjects: ["Matematika", "Český jazyk", "Výtvarná výchova", "Hudební výchova", "Pracovní činnosti"] },
    { day: "Středa", subjects: ["Český jazyk", "Matematika", "Tělesná výchova", "Přírodověda", "Anglický jazyk"] },
    { day: "Čtvrtek", subjects: ["Matematika", "Český jazyk", "Pracovní činnosti", "Hudební výchova", "Výtvarná výchova"] },
    { day: "Pátek", subjects: ["Český jazyk", "Matematika", "Přírodověda", "Tělesná výchova", "Anglický jazyk"] }
  ];

  const galleryImages = [
    { title: "Čtení s porozuměním", description: "Práce s texty a knihami", category: "Český jazyk" },
    { title: "Matematické hry", description: "Procvičování násobilky", category: "Matematika" },
    { title: "Pokusy s vodou", description: "Výzkum přírody", category: "Přírodověda" },
    { title: "Výtvarný projekt", description: "Malování akvarely", category: "Výtvarná výchova" },
    { title: "Angličtina hrou", description: "Učení nových slovíček", category: "Anglický jazyk" },
    { title: "Sportovní aktivity", description: "Týmové hry a cvičení", category: "Tělesná výchova" }
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="fade-in text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Třídní učitelka: Mgr. Eva Benešová
            </p>
            <p className="text-lg text-muted-foreground">
              Prohlubujeme základní dovednosti a objevujeme svět kolem nás.
            </p>
          </div>
        </div>
      </section>
              ...
              <CardContent className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">14 žáků (7 dívek, 7 chlapců)</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Prohlubování čtenářských dovedností, rozvoj logického myšlení v matematice. 
                      Začínáme s angličtinou a poznáváme přírodu kolem nás.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      "Učení je dobrodružství! Každý den objevujeme něco nového 
                      a zajímavého o světě kolem nás."
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Projektové dny, přírodovědné pokusy, dramatizace příběhů, 
                      sportovní soutěže, výlety do přírody.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="fade-in school-card">
              ...
              <CardContent className="space-y-6">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-semibold">Mgr. Eva Benešová</h3>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      ...
                      specializace na elementární vzdělávání a anglický jazyk
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      12 let pedagogické praxe, specializuje se na výuku angličtiny pro mladší žáky
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      "Věřím v sílu pozitivní motivace. Když dítě prožívá radost z učení, 
                      lépe si pamatuje a rádo se vrací k novým vědomostem."
                    </p>
                  </div>
                </div>
              </CardContent>
