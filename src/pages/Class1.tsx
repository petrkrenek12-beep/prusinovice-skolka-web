...
const Class1 = () => {
  const schedule = [
    { day: "Pondělí", subjects: ["Český jazyk", "Matematika", "Výtvarná výchova", "Tělesná výchova", "Anglický jazyk"] },
    { day: "Úterý", subjects: ["Matematika", "Český jazyk", "Přírodověda", "Hudební výchova", "Pracovní činnosti"] },
    { day: "Středa", subjects: ["Český jazyk", "Matematika", "Tělesná výchova", "Výtvarná výchova", "Přírodověda"] },
    { day: "Čtvrtek", subjects: ["Matematika", "Český jazyk", "Anglický jazyk", "Hudební výchova", "Pracovní činnosti"] },
    { day: "Pátek", subjects: ["Český jazyk", "Matematika", "Přírodověda", "Tělesná výchova", "Výtvarná výchova"] }
  ];

  const galleryImages = [
    { title: "První školní den", description: "Pasování prvňáčků", category: "Slavnostní akce" },
    { title: "Vánoční výzdoba", description: "Tvoření vánočních ozdob", category: "Výtvarné aktivity" },
    { title: "Čtení s kamarády", description: "Skupinové čtení pohádek", category: "Český jazyk" },
    { title: "Počítáme s kostkami", description: "Matematika hravou formou", category: "Matematika" },
    { title: "Poznáváme zvířata", description: "Hodina přírodovědy", category: "Přírodověda" },
    { title: "Sportovní den", description: "Atletické disciplíny", category: "Tělesná výchova" }
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="fade-in text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Třídní učitelka: Mgr. Petra Zicháčková
            </p>
            <p className="text-lg text-muted-foreground">
              Nejmenší žáci začínají svou školní cestu. Učíme se číst, psát a počítat hravou formou.
            </p>
          </div>
        </div>
      </section>
              ...
              <CardContent className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">12 žáků (6 dívek, 6 chlapců)</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Rozvoj základních dovedností čtení, psaní a počítání. 
                      Hravá forma výuky s důrazem na individuální tempo každého dítěte.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      "Každé dítě je jiné a má svůj vlastní rytmus učení. 
                      Důležité je, aby se ve škole cítilo bezpečně a rádo se učilo."
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Čtení s předškoláky, dramatizace pohádek, experimentování, 
                      návštěvy knihovny, společné projekty se staršími žáky.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="fade-in school-card">
              ...
              <CardContent className="space-y-6">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-semibold">Mgr. Petra Zicháčková</h3>
                  <p className="text-muted-foreground">Zástupkyně ředitelky</p>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      ...
                      specializace na elementární vzdělávání
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      15 let pedagogické praxe, z toho 8 let na pozici zástupkyně ředitelky
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      "Věřím, že každé dítě má v sobě potenciál. Má úloha je tento potenciál 
                      objevit a pomoci mu rozvinout se."
                    </p>
                  </div>
                </div>
              </CardContent>
